...
\question{2} Cho hàm số $y=x^3-3x^2+1$. Điểm cực tiểu của hàm số tương ứng là:
...
\]
Hỏi có tất cả bao nhiêu giá trị nguyên của tham số $m\in[-20;20]$ để hàm số $y=f(x)$ có đúng $5$ điểm cực trị?
\shortanswer
